...
export class CountryFormComponent implements OnInit {
 ...
 onSubmit() {
  ...
  formData.append('name', this.countryForm.get('name')?.value);
  formData.append('population', this.countryForm.get('population')?.value);
  formData.append('region', this.countryForm.get('region')?.value);
  formData.append('capital', this.countryForm.get('capital')?.value);
  
  // Append the image file if it exists
  const imageFile = this.countryForm.get('image')?.value;
  if (imageFile) {
